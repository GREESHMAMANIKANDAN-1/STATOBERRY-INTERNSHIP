...
![Analysis window explained](images/2f tab exp.png){#fig-5 fig-align="center"}
...
![Transformation options](images/2f transform.png){#fig-6 fig-align="center"}
...
![Multiple comparison test options explained](images/multi.png){#fig-7 fig-align="center"}
...
::: {style="text-align: justify;"}
**Mention the factor being plotted, the distribution of the response variable across factor levels, approximate median values, spread/variability,outliers if any, and the letter groupings confirming statistical significance between levels.**
:::
::::
:::::
::::::
...
::: {style="text-align: justify;"}
**Discuss the distribution shape for each factor level, the concentration of data, the width of each violin indicating density, and any differences in spread or central tendency between levels. Include letter groupings if applicable.**
:::
::::
:::::
::::::
...
::: {style="text-align: justify;"}
**Compare the mean values of the response variable across factor levels with error bars. Mention the approximate mean values for each level, whether error bars overlap, and the letter groupings confirming statistical differences as determined by the LSD/Tukey/DMRT test.**
:::
::::
:::::
::::::
...
::: {style="text-align: justify;"}
**Explain the horizontal line representation of means for each factor level, the approximate positions of each level's mean on the axis, and the letter groupings shown to confirm significant differences between factor levels.**
:::
::::
:::::
::::::
...
::: {style="text-align: justify;"}
**Explain how the mean values for each factor level are connected by a line to highlight the trend across levels. Mention the direction of the trend (increasing/decreasing), approximate mean values, error bars, and the letter groupings confirming statistical differences.**
:::
::::
::::::
:::::::
...
![Advanced plots](images/2f advanced-01.png){#fig-90 fig-align="center"}
...
![AI powered RAISINS Assistant to interpret your results](images/2f ai-01.png){#fig-ai fig-align="center"}
...
![Multivariate tab in RAISINS](images/multi tab 2f.png){#fig-mu}
...
![Manova Results](images/2f manova new.png){#fig-MAN2 fig-align="center"}
...
![Model dataset](images/2f model data.png){#fig-188 fig-align="center"}
...
![View data](images/2f view data.png){fig-align="center"}
