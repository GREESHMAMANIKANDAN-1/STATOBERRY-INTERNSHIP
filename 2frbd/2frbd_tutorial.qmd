...
![Analysis of experiment tab](images/LAYOUT.png){#fig-aov fig-align="center"}
...
::: {style="text-align: justify;"}
To make things simple and interesting, we'll explain 2F-RBD analysis step by step using a working example, so you can clearly see how it works and why it matters. This dataset represents a factorial experiment involving two factors: FactorA and FactorB, each with multiple levels, laid out in a Randomised Block Design. FactorA consists of 2 levels (A1, A2), while FactorB has 2levels (B1, B2). The experiment is conducted in a Randomised Block Design (RBD), where the treatment combinations formed by crossing the levels of FactorA and FactorB are randomly assigned within each of 3 blocks. Observations were recorded for 7 variables. This dataset allows for the examination of the individual effects of FactorA and FactorB, as well as their interaction effects, with block effects accounted for to improve precision. Our aim is to test whether the factors and their interaction produce statistically significant differences in the response variables using ANOVA. The arrangement of the data is shown in the @fig-data.
:::

<!-- REPLACE THIS SCREENSHOT -->

![Example dataset](images/NEW.png){#fig-data fig-align="center"}
...
![Illustrating how to create a dataset](images/rbd%2029-01.png){#fig-4 fig-align="center"}
...
![Analysis window explained](images/rbd%20re.jpeg){#fig-5 fig-align="center"}
...
![Transformation options](images/rbd%20new%202.png){#fig-6 fig-align="center"}
...
![Multiple comparison test options explained](images/rbd%207.png){#fig-7 fig-align="center"}
...
![Box plot](images/rbd%2013.png){#fig-9}
...
![Violin plot](images/rbd%2014.png){#fig-10}
...
![Bar plot](images/rbd%2017.png){#fig-11}
...
![Mean Value Plot](images/rbd%2015-01.png){#fig-12}
...
![Connected line plot](images/rbd%2016.png){#fig-13}
:::
...
![Advanced plots](images/rbd%2011%20a.jpeg){#fig-90 fig-align="center"}
...
![AI powered RAISINS Assistant to interpret your results](images/rbd%2018.png){#fig-ai fig-align="center"}
...
![Multivariate tab in RAISINS](images/rbd%2019.png){#fig-mu}
...
![Manova Results](images/rbd%2020.png){#fig-MAN2 fig-align="center" width="575"}
...
![Creating dataset within RAISINS](images/rbd%2029.png){#fig-createdata}
...
![Model dataset](images/rbd%20888.png){#fig-188 fig-align="center"}
...
![View data](images/rbd%2010.jpeg){fig-align="center"}
