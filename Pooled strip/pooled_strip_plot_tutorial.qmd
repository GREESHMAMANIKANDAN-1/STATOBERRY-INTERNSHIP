...
![PSPD Layout](images/LAYOUT%20POOLED%20STRIP.png){#fig-lay fig-align="center"}
...
::: {style="text-align: justify;"}
An interaction plot is a graphical tool used to study the interaction between two or more factors in an experiment. It helps compare treatment effects, where non-parallel or intersecting lines indicate the presence of interaction between factors
:::

.**3D SCATTER PLOT**

![3D Scatter plot](images/Screen%20Recording%202026-05-08%20121957.gif){#fig-15 fig-align="center"}

::: {style="text-align: justify;"}
A 3D scatter plot is a graphical representation used to display the relationship among three variables on X, Y, and Z axes. It helps visualize patterns, trends, and interactions in multidimensional data.
:::

**3D SCATTER PLOT WITH LINES**

![3D SCATTER PLOT WITH LINE](images/Screen%20Recording%202026-05-08%20122043.gif){#fig-16 fig-align="center"}

::: {style="text-align: justify;"}
3D Scatter Plot with Lines: A 3D scatter plot with lines is used to display the relationship among three variables by plotting data points on X, Y, and Z axes and connecting them with lines to show trends, patterns, or progression in the data.
:::
