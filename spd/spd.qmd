...
Split Plot Design is a two-factor experimental design in which experimental units are arranged in two layers - main plots and sub-plots, allowing factors that require larger experimental units to be assigned to main plots while factors requiring smaller, more precise units are assigned within sub-plots. **Split Plot Design** accommodates two distinct sources of experimental error, one for main plot comparisons and another for sub-plot and interaction comparisons, thereby improving precision for sub-plot factor estimates. In **RAISINS** you can perform SPD very easily without writing a single line of code. This tutorial will guide you on how to perform SPD easily in **RAISINS** and interpret the results effectively. In addition, you will get tables and plots ready for publication. You can also perform multivariate analysis including MANOVA and PCA.
:::
...
![Analysis of experiment tab](images/analyss-03.png){#fig-aov fig-align="center"}
...
![SPD Layout](images/Copy of Copy of Red Modern Blank Page A4 Landscape.png){#fig-4 fig-align="center"}
...
## Split Plot Design analysis tab explained {#sec-5 .T}

::: {style="text-align: justify;"}
In @fig-5, you can see the detailed view of the Analysis tab, along with explanations of what each option does. This section helps you to understand the purpose of every setting, so you can select the most appropriate ones for your data and analysis. Now, upload the prepared file by clicking browse in the sidebar of the analysis tab.when the file is uploaded option to select the Main plot,Sub plot,Replication and variables will appear.select the appropriate column representing the main ploy factor under main plot,the subplot factor under subplot and replication identifies as replication.then select the responsible variables you wish to analysis.once you click the Run analysis button, all relevant results and outputs appear instantly leaving no room for confusion.
:::

![Analysis window explained](images/ggg-01.png){#fig-5 fig-align="center"}
...
![Transformation options](images/Copy%20of%20Red%20Modern%20Blank%20Page%20A4%20Landscape%20(4).png){#fig-6 fig-align="center"}
...
In our example with a = 1 main plot levels, b = 2 sub-plot levels, and r = 3 replications: Replication df = 2, Main Plot df = 0, Main Plot Error df = 0, Sub-plot df = 1, Interaction df = 0, Sub-plot Error df = 2, Total df = 5. The F-value for the Main Plot factor is computed as MS(A) / MS(Error a), while the F-values for the Sub-plot and Interaction are computed as MS(B) / MS(Error b) and MS(A×B) / MS(Error b) respectively. Significance is indicated by an asterisk ( \* ) for the **5%** level and two asterisks (\*\*) for the **1%** level of significance, displayed as superscripts for each corresponding F stat in the table. If the computed F value exceeds the critical value, the null hypothesis is rejected for that source of variation. </small>
...
![Detailed tabular representation with multiple comparisons](images/Screenshot%202026-04-27%20144941.png){#fig-101 fig-align="center"}

![Detailed tabular representation with multiple comparisons](images/Screenshot%202026-04-27%20145003.png){fig-align="center"}
...
![Multiple comparison test options explained](images/Copy%20of%20Red%20Modern%20Blank%20Page%20A4%20Landscape%20(3)-01.png){#fig-7 fig-align="center"}
...
![Plot settings for customizing](images/WhatsApp%20Image%202026-04-28%20at%2012.59.45%20PM-01.jpeg){#fig-8 fig-align="center"}
...
![Box plot](images/Screenshot%202026-04-28%20103100-01.png){#fig-9}
...
![Violin plot](images/Screenshot%202026-04-28%20103127.png){#fig-10}
...
![Bar plot](images/Screenshot%202026-04-28%20103220-01.png){#fig-11}
...
![Mean Value Plot](images/Screenshot%202026-04-28%20103142-02.png){#fig-12}
...
![Connected line plot](images/Screenshot%202026-04-28%20103158-01.png){#fig-13}
:::
...
![Advanced plots](images/Copy of Copy of Red Modern Blank Page A4 Landscape (1).png){#fig-90 fig-align="center"}

![Advanced plots](images/Screenshot%202026-04-30%20115407.png){fig-align="center"}

**PLOT WISE GRAPH**

![Plot Wise Graph](images/Screenshot%202026-04-28%20103846-02.png){fig-align="center"}

Plot wise graph This figure shows a plot-wise graphical representation of a split-plot experiment, where the overall graph is divided into smaller panels for yield and different characters (Char1 to Char6). Each bar represents the mean value of a parameter under different sub-plot treatments (1, 2, and 3), while the vertical lines indicate variation or standard error. The x-axis shows the main plot treatments (such as M1 and M2), and the y-axis represents the measured values. This visualization helps compare the effect of different treatment combinations on yield and other traits, making it easier to identify the best-performing treatments.

**INTERACTION PLOT**

![Interaction plot](images/Screenshot%202026-04-28%20110815.png){fig-align="center"}

This figure shows an interaction plot used to understand the combined effect of main plot and sub-plot treatments on a response variable. The lines represent different treatment levels, and their trends across the x-axis indicate how one factor behaves at different levels of another factor. The presence of non-parallel or crossing lines suggests an interaction effect, meaning the influence of one factor depends on the level of the other factor. The points indicate mean values, while the vertical bars show variability (standard error). Overall, this plot helps in identifying whether treatments act independently or interact with each other in affecting the response.

**3 D SCATTER PLOT**

![3D Scatter plot](images/239.gif){#fig-16 fig-align="center"}

::: {style="text-align: justify;"}
This figure shows a 3D scatter plot representing the mean response (yield) for different combinations of main plot and sub-plot treatments. The three axes correspond to main plot treatments, sub-plot treatments, and the response variable (yield). Each point in the plot represents a specific treatment combination, with its position indicating the corresponding yield value. This visualization helps in understanding how yield varies across different treatment combinations and makes it easier to observe patterns, trends, or possible interactions between main plot and sub-plot factors.
:::

**3 D SCATTER PLOT WITH LINES**

![3D Scatter plot with lines](images/scatter%20line%20plot.gif){#fig-17 fig-align="center"}

::: {style="text-align: justify;"}
This figure shows a 3D scatter plot with connecting lines, illustrating the mean response (yield) across different combinations of main plot and sub-plot treatments. The three axes represent the main plot levels, sub-plot levels, and the corresponding yield values. Each point indicates the mean yield for a specific treatment combination, while the lines connecting the points help visualize trends and relationships between treatments. This makes it easier to observe how yield changes across different levels and to identify patterns or possible interactions between the factors.
:::
...
![AI powered RAISINS Assistant to interpret your results](images/Screenshot%202026-04-28%20111921.png){#fig-ai fig-align="center"}
...
![Multivariate tab in RAISINS](images/Copy%20of%20Red%20Modern%20Blank%20Page%20A4%20Landscape%20(5).png){#fig-mu}
...
![PCA-based Index Score](images/Screenshot%202026-04-28%20114144.png){#fig-PC}

::: {style="text-align: justify;"}
The scree plot given @fig-screeplot illustrates the proportion of variance explained by each principal component.
:::

![Scree plot](images/Screenshot%202026-04-28%20112629-01.png){#fig-screeplot fig-align="center"}
...
![Loadings of each variable](images/Screenshot%202026-04-28%20114144-01.png){#fig-loadings fig-align="center"}
...
![PCA-Biplot](images/Screenshot%202026-04-28%20112808-01.png){#fig-biplot}
...
![](images/Screenshot%202026-04-28%20114639.png){#fig-indexscore fig-align="center"}

![Index score and Index plot](images/Screenshot%202026-04-28%20114720.png){#fig-index fig-align="center"}
...
![Model-1: showing how the prepared Excel file for upload should look like](images/WhatsApp%20Image%202026-04-28%20at%2011.49.25%20AM.jpeg){#fig-pp}

![Model-2: Showing how the prepared Excel file for upload should look like](images/WhatsApp%20Image%202026-04-28%20at%2011.49.24%20AM%20(2).jpeg){#fig-kk}
...
![Create Dataset](images/Copy of Copy of Red Modern Blank Page A4 Landscape-01.png){#fig-createdata fig-align="center"}
...
![Model dataset](images/WhatsApp%20Image%202026-04-28%20at%2011.49.23%20AM.jpeg){#fig-188 fig-align="center"}
...
![FAQs](images/WhatsApp%20Image%202026-04-28%20at%2011.49.24%20AM%20(1).jpeg){#fig-148 fig-align="center"}
...
![View data](images/WhatsApp%20Image%202026-04-28%20at%2011.49.24%20AM-02.jpeg){fig-align="center"}
