...
A **pairs plot** in strip plot design is a graphical method used to show the relationships between multiple variables or treatment factors. It consists of a matrix of scatter plots where each variable is plotted against every other variable. The diagonal may display histograms or distributions of individual variables. This plot helps in identifying correlations, patterns, and interactions between factors. It is useful for understanding how different variables in the experiment are related to each other in a simple visual way.

![Pairs Plot](images/basic plot.png){alt="Box plot" width="857"}
...
![Plot Wise Graph](images/WhatsApp Image 2026-04-29 at 3.06.26 PM (1).jpeg){fig-align="center"}
...
![Interaction Plot](images/WhatsApp Image 2026-04-29 at 3.06.54 PM.jpeg){fig-align="center"}
...
![3D Scatter Plot](images/ssstrip ppplot-01.gif){#fig-AP3 fig-align="center"}
...
![3D Scatter Plot With Lines](images/sstrip plott-03.gif){fig-align="center"}
